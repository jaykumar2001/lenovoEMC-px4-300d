...
#define SIO_F71808E_ID		0x0901  /* F71808E chipset ID */
...
enum chips { f71808e, f71869, f71869a, f71882fg, f71889a, f71889f, f81866 };
...
static int f7188x_gpio_set(struct gpio_chip *chip, unsigned offset, int value);
...
static struct f7188x_gpio_bank f71808e_gpio_bank[] = {
	F7188X_GPIO_BANK(0, 8, 0xF0),
	F7188X_GPIO_BANK(10, 5, 0xE0),
	F7188X_GPIO_BANK(20, 8, 0xD0),
	F7188X_GPIO_BANK(30, 5, 0xC0),
};
...
static int f7188x_gpio_probe(struct platform_device *pdev)
{
	...
	switch (sio->type) {
	case f71808e:
		data->nr_bank = ARRAY_SIZE(f71808e_gpio_bank);
		data->bank = f71808e_gpio_bank;
		break;
	case f71869:
...
MODULE_DESCRIPTION("GPIO driver for Super-I/O chips F71808E, F71869, F71869A, F71882FG, F71889A, F71889F and F81866");
